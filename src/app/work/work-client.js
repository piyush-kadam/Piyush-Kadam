...
// Video Player Component - OUTSIDE main component
...
// Image Slideshow Component - OUTSIDE main component
...
export default function SimpleSpacePortfolio() {
  // ── KEY FIX: check sessionStorage immediately — no flash ──
  const [loaded, setLoaded] = useState(() => {
    if (typeof window !== "undefined") {
      return sessionStorage.getItem("workLoaded") === "true";
    }
    return false;
  });
